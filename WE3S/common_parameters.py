...
SWITCH_TO_AWAKE_DURATION = Timestamp(2.6 * 10**-3)
SWITCH_TO_DOZE_DURATION = Timestamp(0.8 * 10**-3)
MIN_DOZE_DURATION = SWITCH_TO_DOZE_DURATION + SWITCH_TO_AWAKE_DURATION
...
# SWITCH_TO_AWAKE_CONSUMPTION = IDLE_CONSUMPTION
# SWITCH_TO_DOZE_CONSUMPTION = IDLE_CONSUMPTION
